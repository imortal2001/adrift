...
| `tools/build_player.py` | Converts a Ready Player Me character (CC BY-NC-SA 4.0, see CREDITS.md) into the player's body: faces the game's forward, bone names cleaned, dressed for the Stone Age by repainting, textures shrunk. |
